...
<?php echo form_open_multipart("Datavoice/proses"); ?>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label for="email2">judul voice</label>
												<input type="text" class="form-control" name="judul" placeholder="masukan judul voice">
											...
											<div class="form-group">
												<label for="comment">keterangan</label>
											<select class="form-control" name="id_album" id="">
