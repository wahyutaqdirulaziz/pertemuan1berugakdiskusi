				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div><?php $var = 'Datavoice'; if($this->uri->segment(1) == 'Datavoice'){?>
								<h2 class="text-white pb-2 fw-bold">Happy playing</h2>
								<h5 class="text-white op-7 mb-2">situs voice kresahan mahasiswa</h5>
								<?php }else if($this->uri->segment(1) == 'Album'){?>
									<h2 class="text-white pb-2 fw-bold">album</h2>
								    <h5 class="text-white op-7 mb-2">album terbaik mahasiswa</h5>
									<?php }else{?>
							...
							<div class="ml-md-auto py-2 py-md-0">
								...
								<?php $var = 'Datavoice'; if($this->uri->segment(1) == 'Datavoice' ){?>
								<a href="<?= site_url('Datavoice/create')?>" class="btn btn-secondary btn-round">Add voice</a>
								<?php }else{?>
			...
			<footer class="footer">
				<div class="container-fluid">
					<nav class="pull-left">
						<ul class="nav">
							<li class="nav-item">
								<a class="nav-link" href="wahyudipe6@gmail.com">
									wahyudev
								</a>
							</li>
							<li class="nav-item">
					...
					<div class="copyright ml-auto">
						2018, made with <i class="fa fa-heart heart text-danger"></i> by <a href="wahyudipe6@gmail.com">wahyudev</a>
					</div>				
				</div>
			</footer>
		</div>
